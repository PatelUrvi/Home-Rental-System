...
if(isset($_GET['tenant_id']) && isset($_GET['property_id']))
{
    ...
    $_SESSION['pro_id']=$_GET['property_id'];
}
...
<html>
        ...
        <div class="container">
            <div class="row">
                ...
                <?php
                    ...
                    $get1 = mysqli_query($con, "select * from tbl_leaseout_notification where tenant_emailid='".$id."'");
    ...
    <?php
        if(isset($_POST['view']))
        {
            ...
            $q = mysqli_query($con, "update tbl_leaseout_notification set status = 'accept', owner_mess = 'The Property Owner ".$row2['name']." has excepted your request to lease out the house and refund your deposit.' where tenant_emailid = '".$id."' and property_id  = '".$property_id."' and owner_emailid = '".$_SESSION['emailid']."'");
            if($q)
            {
                echo '<script>location.href="rrefund_deposit.php"</script>';
            }
            else 
            {
                echo '<script>location.href="view_tenant_detail2.php"</script>';
            }
        }
        if(isset($_POST['reject']))
        {
            ...
            $q7 = mysqli_query($con, "update tbl_leaseout_notification set status = 'reject', owner_mess = 'The Property Owner ".$row11['name']." has rejected your request to lease out the house.' where tenant_emailid = '".$id."' and property_id  = '".$property_id."' and owner_emailid = '".$_SESSION['emailid']."'");
            if($q7)
            {
