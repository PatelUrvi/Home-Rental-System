                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <div class="mx-auto d-block">
                                                        <img class="rounded-circle mx-auto d-block" src="./tenant_photo/<?php echo $edit_p['user_photo']; ?>" alt="Card image cap">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <div class="mx-auto d-block">
                                                        ...
                                                        <br>
                                                        <label><b>Contact No :&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></label><label><?php echo $edit_p['contactno']; ?></label>
                                                        <br>
                                                        <br>
                                                    <hr>
                                                    <div class="card-text text-sm-center">
                                                        <a href="edit_profile_for_tenants.php">
