	...
	<div class="row">
      ...
      <div class="col-md-3">
        <div class="text-center">
            <img src="./Property_Owner_Photo/<?php echo $edit_p['photo']; ?>" height="40px" width="40px" class="img-circle" alt="avatar">
      ...
      <div class="col-md-9 personal-info">
        <h3>Personal info</h3>
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">
                <input class="form-control" type="text" name="contact" placeholder="6-9 123456789" value="<?php echo $edit_p['contact_no']; ?>" pattern="[6-9]{1}[0-9]{9}" required>
            </div>
          </div>
          <div class="form-group">
...
if(isset($_POST['submit']))
{
       ...
       $target_dir = "./Property_Owner_Photo/".$profile;
       ...
       $contact = $_POST['contact'];
        if($name != "" && $addres != "" && $contact != "")
        {
            ...
            {
             $result1 = mysqli_query($con,"update tbl_property_owner set name='".$name."',address='".$addres."',contact_no='".$contact."',photo='".$profile."' where emailid='".$_SESSION['emailid']."'");
             if($result1)
             {
