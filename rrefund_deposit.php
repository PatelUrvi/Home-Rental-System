...
$data = mysqli_query($con, "select * from tbl_property_owner where emailid='".$_SESSION['emailid']."'");
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    ...
                    <div class="breadcumb-content">
                        <h3 class="breadcumb-title" style=" font-size: 35px;">Refund Deposit</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="contact-heading">
                        <h6 style="font-size: 30px;">Refund Deposit</h6>
                    </div>
                </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <div class="mx-auto d-block">
                                                        ...
                                                        <input type="hidden" name="surl" value="http://localhost/Rental_Home_System/success1.php"/></td>
                                                        <input type="hidden" name="furl" value="http://localhost/Rental_Home_System/failure1.php" />
                                                        ...
                                                        <br>
                                                        <label><b>Contact No :&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></label><label><?php echo $data_d['contact_no']; ?></label>
                                                        <br>
