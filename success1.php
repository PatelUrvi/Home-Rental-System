...
$data = mysqli_query($con, "select * from tbl_property_owner where emailid='".$_SESSION['email']."'");
$data_d = mysqli_fetch_assoc($data);
$tenant_id = $data_d['Tenant_id'];
$id = $_SESSION['pro_id'];
$getdata = mysqli_query($con, "update tbl_property_detail set status='lease out' where property_id = $id");
...
// Salt should be same Post Request
    ...
    <?php
    //$q = mysqli_query($con, "update tbl_leaseout_notification set n_status = 'deactive' where owner_emailid = '".$_SESSION['emailid']."' and property_id = '".$id."' ");
